...
import { Accordion as AccordionElement } from "@pap-it/accordion";
import "@pap-it/accordion/wc";

// we also want to export our element's
export { Accordion as AccordionElement } from "@pap-it/accordion";

export type Props = PapReactElement<AccordionAttributes> & {
  onClick?: EventHandler;
}

export const Accordion = forwardRef<AccordionElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<AccordionElement>(null);
