...
import { Option as OptionElement } from "@pap-it/dropdown-depricated";
import "@pap-it/dropdown-depricated/wc";

// we also want to export our element's
export { Option as OptionElement } from "@pap-it/dropdown-depricated";

export type Props = PapReactElement<OptionAttributes> & {
  onClick?: EventHandler;
}

export const Option = forwardRef<OptionElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<OptionElement>(null);
