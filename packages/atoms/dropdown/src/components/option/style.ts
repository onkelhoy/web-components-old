export const style = `:host {
  ...
  cursor: pointer;
  user-select: none;
  --option-background-hover: var(--o-option-background-hover-light, var(--o-color-hover-100, rgba(0,0,0,0.03)));
  --option-background-active: var(--o-option-background-active-light, var(--o-color-hover-400, rgba(0,0,0,0.1))); }
