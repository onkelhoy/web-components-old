...
import { Icon as IconElement } from "@pap-it/icon";
import "@pap-it/icon/wc";

// we also want to export our element's
export { Icon as IconElement } from "@pap-it/icon";

export type Props = PapReactElement<IconAttributes> & {
  onClick?: EventHandler;
}

export const Icon = forwardRef<IconElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<IconElement>(null);
