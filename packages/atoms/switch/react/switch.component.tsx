...
import { Switch as SwitchElement } from "@pap-it/switch";
import "@pap-it/switch/wc";

// we also want to export our element's
export { Switch as SwitchElement } from "@pap-it/switch";

export type Props = PapReactElement<SwitchAttributes> & {
  onClick?: EventHandler;
}

export const Switch = forwardRef<SwitchElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<SwitchElement>(null);
