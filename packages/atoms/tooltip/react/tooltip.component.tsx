...
import { Tooltip as TooltipElement } from "@pap-it/tooltip";
import "@pap-it/tooltip/wc";

// we also want to export our element's
export { Tooltip as TooltipElement } from "@pap-it/tooltip";

export type Props = PapReactElement<TooltipAttributes> & {
  onClick?: EventHandler;
}

export const Tooltip = forwardRef<TooltipElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TooltipElement>(null);
