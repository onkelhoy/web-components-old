...
import { Checkbox as CheckboxElement } from "@pap-it/checkbox";
import "@pap-it/checkbox/wc";

// we also want to export our element's
export { Checkbox as CheckboxElement } from "@pap-it/checkbox";

export type Props = PapReactElement<CheckboxAttributes> & {
  onClick?: EventHandler;
}

export const Checkbox = forwardRef<CheckboxElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<CheckboxElement>(null);
