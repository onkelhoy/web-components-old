...
import { Divider as DividerElement } from "@pap-it/divider";
import "@pap-it/divider/wc";

// we also want to export our element's
export { Divider as DividerElement } from "@pap-it/divider";

export type Props = PapReactElement<DividerAttributes> & {
  onClick?: EventHandler;
}

export const Divider = forwardRef<DividerElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<DividerElement>(null);
