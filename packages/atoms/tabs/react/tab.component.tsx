...
import { Tab as TabElement } from "@pap-it/tabs";
import "@pap-it/tabs/wc";

// we also want to export our element's
export { Tab as TabElement } from "@pap-it/tabs";

export type Props = PapReactElement<TabAttributes> & {
  onClick?: EventHandler;
}

export const Tab = forwardRef<TabElement, Props>((props, forwardref) => {
