...
import { Tabs as TabsElement } from "@pap-it/tabs";
import "@pap-it/tabs/wc";

// we also want to export our element's
export { Tabs as TabsElement } from "@pap-it/tabs";

export type Props = PapReactElement<TabsAttributes> & {
  onClick?: EventHandler;
}

export const Tabs = forwardRef<TabsElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TabsElement>(null);
