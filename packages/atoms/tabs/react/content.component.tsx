...
import { TabContent as TabContentElement } from "@pap-it/tabs";
import "@pap-it/tabs/wc";

// we also want to export our element's
export { TabContent as TabContentElement } from "@pap-it/tabs";

export type Props = PapReactElement<TabContentAttributes> & {
  onClick?: EventHandler;
}

export const TabContent = forwardRef<TabContentElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TabContentElement>(null);
