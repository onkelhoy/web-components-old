...
import { Select as SelectElement } from "@pap-it/select";
import "@pap-it/select/wc";

// we also want to export our element's
export { Select as SelectElement } from "@pap-it/select";

export type Props = PapReactElement<SelectAttributes> & {
  onClick?: EventHandler;
}

export const Select = forwardRef<SelectElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<SelectElement>(null);
