...
import { Editor as EditorElement } from "@pap-it/editor";
import "@pap-it/editor/wc";

// we also want to export our element's
export { Editor as EditorElement } from "@pap-it/editor";

export type Props = PapReactElement<EditorAttributes> & {
  onClick?: EventHandler;
}

export const Editor = forwardRef<EditorElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<EditorElement>(null);
