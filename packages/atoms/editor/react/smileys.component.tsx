...
import { Smileys as SmileysElement } from "@pap-it/editor";
import "@pap-it/editor/wc";

// we also want to export our element's
export { Smileys as SmileysElement } from "@pap-it/editor";

export type Props = PapReactElement<SmileysAttributes> & {
  onClick?: EventHandler;
}

export const Smileys = forwardRef<SmileysElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<SmileysElement>(null);
