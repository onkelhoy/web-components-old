...
import { Button as ButtonElement } from "@pap-it/button";
import "@pap-it/button/wc";

// we also want to export our element's
export { Button as ButtonElement } from "@pap-it/button";

export type Props = PapReactElement<ButtonAttributes> & {
  onClick?: EventHandler;
}

export const Button = forwardRef<ButtonElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<ButtonElement>(null);
