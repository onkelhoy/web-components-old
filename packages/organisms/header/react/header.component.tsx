...
import { Header as HeaderElement } from "@pap-it/header";
import "@pap-it/header/wc";

// we also want to export our element's
export { Header as HeaderElement } from "@pap-it/header";

export type Props = PapReactElement<HeaderAttributes> & {
  onClick?: EventHandler;
}

export const Header = forwardRef<HeaderElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<HeaderElement>(null);
