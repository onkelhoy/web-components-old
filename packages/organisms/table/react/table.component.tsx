...
import { Table as TableElement } from "@pap-it/table";
import "@pap-it/table/wc";

// we also want to export our element's
export { Table as TableElement } from "@pap-it/table";

export type Props = PapReactElement<TableAttributes> & {
  onClick?: EventHandler;
}

export const Table = forwardRef<TableElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TableElement>(null);
