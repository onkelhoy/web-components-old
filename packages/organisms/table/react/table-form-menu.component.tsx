...
import { TableFormMenu as TableFormMenuElement } from "@pap-it/table";
import "@pap-it/table/wc";

// we also want to export our element's
export { TableFormMenu as TableFormMenuElement } from "@pap-it/table";

export type Props = PapReactElement<TableFormMenuAttributes> & {
  onClick?: EventHandler;
}

export const TableFormMenu = forwardRef<TableFormMenuElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TableFormMenuElement>(null);
