...
import { TableSheets as TableSheetsElement } from "@pap-it/table";
import "@pap-it/table/wc";

// we also want to export our element's
export { TableSheets as TableSheetsElement } from "@pap-it/table";

export type Props = PapReactElement<TableSheetsAttributes> & {
  onClick?: EventHandler;
}

export const TableSheets = forwardRef<TableSheetsElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TableSheetsElement>(null);
