...
import { TableMenu as TableMenuElement } from "@pap-it/table";
import "@pap-it/table/wc";

// we also want to export our element's
export { TableMenu as TableMenuElement } from "@pap-it/table";

export type Props = PapReactElement<TableMenuAttributes> & {
  onClick?: EventHandler;
}

export const TableMenu = forwardRef<TableMenuElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TableMenuElement>(null);
