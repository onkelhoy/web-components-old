...
import { TableActionMenu as TableActionMenuElement } from "@pap-it/table";
import "@pap-it/table/wc";

// we also want to export our element's
export { TableActionMenu as TableActionMenuElement } from "@pap-it/table";

export type Props = PapReactElement<TableActionMenuAttributes> & {
  onClick?: EventHandler;
}

export const TableActionMenu = forwardRef<TableActionMenuElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<TableActionMenuElement>(null);
