...
import { Markdown as MarkdownElement } from "@pap-it/markdown";
import "@pap-it/markdown/wc";

// we also want to export our element's
export { Markdown as MarkdownElement } from "@pap-it/markdown";

export type Props = PapReactElement<MarkdownAttributes> & {
  onClick?: EventHandler;
}

export const Markdown = forwardRef<MarkdownElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<MarkdownElement>(null);
