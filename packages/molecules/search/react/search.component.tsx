...
import { Search as SearchElement } from "@pap-it/search";
import "@pap-it/search/wc";

// we also want to export our element's
export { Search as SearchElement } from "@pap-it/search";

export type Props = PapReactElement<SearchAttributes> & {
  onClick?: EventHandler;
}

export const Search = forwardRef<SearchElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<SearchElement>(null);
