...
import { Steps as StepsElement } from "@pap-it/steps";
import "@pap-it/steps/wc";

// we also want to export our element's
export { Steps as StepsElement } from "@pap-it/steps";

export type Props = PapReactElement<StepsAttributes> & {
  onClick?: EventHandler;
}

export const Steps = forwardRef<StepsElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<StepsElement>(null);
