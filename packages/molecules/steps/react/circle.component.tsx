...
import { Circle as CircleElement } from "@pap-it/steps";
import "@pap-it/steps/wc";

// we also want to export our element's
export { Circle as CircleElement } from "@pap-it/steps";

export type Props = PapReactElement<CircleAttributes> & {
  onClick?: EventHandler;
}

export const Circle = forwardRef<CircleElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<CircleElement>(null);
