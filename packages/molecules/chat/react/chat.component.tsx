...
import { Chat as ChatElement } from "@pap-it/chat";
import "@pap-it/chat/wc";

// we also want to export our element's
export { Chat as ChatElement } from "@pap-it/chat";

export type Props = PapReactElement<ChatAttributes> & {
  onClick?: EventHandler;
}

export const Chat = forwardRef<ChatElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<ChatElement>(null);
