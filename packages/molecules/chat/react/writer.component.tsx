...
import { Writer as WriterElement } from "@pap-it/chat";
import "@pap-it/chat/wc";

// we also want to export our element's
export { Writer as WriterElement } from "@pap-it/chat";

export type Props = PapReactElement<WriterAttributes> & {
  onClick?: EventHandler;
}

export const Writer = forwardRef<WriterElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<WriterElement>(null);
