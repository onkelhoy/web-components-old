...
import { LanguageMenu as LanguageMenuElement } from "@pap-it/language-menu";
import "@pap-it/language-menu/wc";

// we also want to export our element's
export { LanguageMenu as LanguageMenuElement } from "@pap-it/language-menu";

export type Props = PapReactElement<LanguageMenuAttributes> & {
  onClick?: EventHandler;
}

export const LanguageMenu = forwardRef<LanguageMenuElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<LanguageMenuElement>(null);
