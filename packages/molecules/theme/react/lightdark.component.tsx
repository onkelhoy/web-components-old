...
import { Lightdark as LightdarkElement } from "@pap-it/theme";
import "@pap-it/theme/wc";

// we also want to export our element's
export { Lightdark as LightdarkElement } from "@pap-it/theme";

export type Props = PapReactElement<LightdarkAttributes> & {
  onClick?: EventHandler;
}

export const Lightdark = forwardRef<LightdarkElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<LightdarkElement>(null);
