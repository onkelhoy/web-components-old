...
import { SidebarContact as SidebarContactElement } from "@pap-it/sidebar-contact";
import "@pap-it/sidebar-contact/wc";

// we also want to export our element's
export { SidebarContact as SidebarContactElement } from "@pap-it/sidebar-contact";

export type Props = PapReactElement<SidebarContactAttributes> & {
  onClick?: EventHandler;
}

export const SidebarContact = forwardRef<SidebarContactElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<SidebarContactElement>(null);
