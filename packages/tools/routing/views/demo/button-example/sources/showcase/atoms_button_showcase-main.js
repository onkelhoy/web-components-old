...
const windowFuncatoms_button_showcase_load = () => 
{
  console.log('[demo]: window loaded');

  const component_table = document.querySelector('pap-tab-content[id="showcase"] section#atoms_button_showcase_component + section tbody');
...
window.addEventListener("load", windowFuncatoms_button_showcase_load)