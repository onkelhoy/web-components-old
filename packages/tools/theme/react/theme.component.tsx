...
import { Theme as ThemeElement } from "@pap-it/tools-theme";
import "@pap-it/tools-theme/wc";

// we also want to export our element's
export { Theme as ThemeElement } from "@pap-it/tools-theme";

export type Props = PapReactElement<ThemeAttributes> & {
  onClick?: EventHandler;
}

export const Theme = forwardRef<ThemeElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<ThemeElement>(null);
