...
import { Asset as AssetElement } from "@pap-it/templates-asset";
import "@pap-it/templates-asset/wc";

// we also want to export our element's
export { Asset as AssetElement } from "@pap-it/templates-asset";

export type Props = PapReactElement<AssetAttributes> & {
  onClick?: EventHandler;
}

export const Asset = forwardRef<AssetElement, Props>((props, forwardref) => {
  const { children, onClick, ...restprops } = props;

  const internalref = useRef<AssetElement>(null);
