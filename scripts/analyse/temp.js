...
:host([variant="underlined"][disabled]) {
  text-decoration-thickness: var(--button-underlined-disabled-thickness, 1px); }`;var v=class extends m{constructor(){super();this.size="medium";this.mode="hug";this.variant="filled";this.tabIndex=1;setTimeout(()=>{this.color||(this.color="primary")},1)}render(){return`
        ...
        `}};v.styles=[m.style,T],x([b()],v.prototype,"size",2),x([b()],v.prototype,"mode",2),x([b()],v.prototype,"variant",2),x([b()],v.prototype,"tabIndex",2);var O=customElements!=null?customElements:window==null?void 0:window.customElements;if(!O)throw new Error("Custom Elements not supported");O.get("o-button")||O.define("o-button",v);
