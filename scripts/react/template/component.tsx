...
import { TEMPLATE_CLASSNAME as TEMPLATE_CLASSNAMEElement } from "TEMPLATE_IMPORT";
import "TEMPLATE_IMPORT/wc";

// we also want to export our element's
export { TEMPLATE_CLASSNAME as TEMPLATE_CLASSNAMEElement } from "TEMPLATE_IMPORT";
